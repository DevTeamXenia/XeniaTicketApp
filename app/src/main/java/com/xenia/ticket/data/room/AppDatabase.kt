...
@Database(
    entities = [Company::class, Category::class, ActiveTicket::class, Ticket::class, LabelSettings::class, TicketComboMapping::class],
    version = 1,
    exportSchema = false
)
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun mappingDao(): TicketComboMappingDao
